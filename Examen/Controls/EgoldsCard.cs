...
namespace Examen
{
    public class EgoldsCard : Control
    {
        ...
        Animation.Animation animCurtain;
        ...
        public EgoldsCard()
        {
            ...
            animCurtain = new Animation.Animation();
        ...
        private void DoCurtainAnimation()
        {
            ...
            {
                animCurtain = new Animation.Animation("Curtain_" + Handle, Invalidate, animCurtain.Value, CurtainMinHeight);
            }
            else
            {
                animCurtain = new Animation.Animation("Curtain_" + Handle, Invalidate, animCurtain.Value, CurtainHeight);
            }

            Animation.Animator.Request(animCurtain, true);
        }
    }
}
