    ...
    public class EgoldsGoogleTextBox : Control
    {
        ...
        private void TextPreviewAction(bool OnTop)
        {
            if (OnTop)
            {
                ...
                {
                    LocationTextPreviewAnim = new Animation.Animation("TextPreviewLocationY" + Handle, Invalidate, LocationTextPreviewAnim.Value, 0);
                    FontSizeTextPreviewAnim = new Animation.Animation("TextPreviewFontSize" + Handle, Invalidate, FontSizeTextPreviewAnim.Value, FontTextPreview.Size);
                }
                else
                {
                    tbInput.Focus();
            ...
            else
            {
                ...
                {
                    LocationTextPreviewAnim = new Animation.Animation("TextPreviewLocationY" + Handle, Invalidate, LocationTextPreviewAnim.Value, tbInput.Location.Y);
                    FontSizeTextPreviewAnim = new Animation.Animation("TextPreviewFontSize" + Handle, Invalidate, FontSizeTextPreviewAnim.Value, Font.Size);
                }
                else
                {
                    return;
            ...
            Animation.Animator.Request(LocationTextPreviewAnim, true);
            Animation.Animator.Request(FontSizeTextPreviewAnim, true);
        }
