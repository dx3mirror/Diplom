...
namespace Examen
{
    ...
    public class EgoldsToggleSwitch : Control
    {
        ...
        private Animation.Animation ToggleAnim = new Animation.Animation();
        ...
        private void SwitchToggle()
        {
            if (Checked == true)
            {
                ToggleAnim = new Animation.Animation("Toggle_" + Handle, Invalidate, ToggleAnim.Value, TogglePosX_ON);
            }
            else
            {
                ToggleAnim = new Animation.Animation("Toggle_" + Handle, Invalidate, ToggleAnim.Value, TogglePosX_OFF);
            }

            ToggleAnim.StepDivider = 8;
            Animation.Animator.Request(ToggleAnim, true);
